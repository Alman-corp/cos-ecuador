...
export function Sidebar() {
  ...
  return (
    <>
      <aside
        className={`hidden md:flex h-full flex-col border-r border-surface-700/50 bg-surface-950 transition-all duration-200 ${
          collapsed ? "w-16" : "w-64"
        }`}
      >
        <button
          onClick={toggle}
          className="absolute top-4 right-2 z-10 hidden md:flex h-6 w-6 items-center justify-center rounded-md text-surface-400 hover:text-surface-200"
        >
      ...
      <Sheet>
        ...
        <SheetContent side="left" className="w-64 bg-surface-950 p-0">
          <SidebarContent />
        </SheetContent>
      </Sheet>
    </>
